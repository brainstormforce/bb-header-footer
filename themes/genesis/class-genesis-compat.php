	...
	*/
	...
	public function hooks() {
		...
		if ( $header_id !== '' ) {
			...
			add_action( 'genesis_header', array( 'Dynamic_Header_Footer', 'get_header_content' ), 16 );
		}
		...
		if ( $footer_id !== '' ) {
			...
			add_action( 'genesis_footer', array( 'Dynamic_Header_Footer', 'get_footer_content' ), 16 );
		}
